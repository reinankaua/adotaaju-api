...
public class PetController {
   ...
   public ResponseEntity<GenericResponse<Page<PetDTO.Response>>> searchByCriteria(@Valid PetDTO.Response petDTO, Pageable pageable) {
   ...
   @PutMapping("/update/")
   public ResponseEntity<GenericResponse<PetDTO.Response>> update(@RequestParam Long id, @RequestBody PetDTO.Request petDTO)
           throws Exception {
